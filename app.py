...
def check_password():
    ...
    <div style="text-align: center; padding: 60px 20px;">
        <h1 style="color: {NC_BLUE}; font-size: 3rem; margin-bottom: 10px;">VERA-NC</h1>
        <p style="color: #666; font-size: 1.1rem; margin-bottom: 40px;">
            Verification Engine for Results &amp; Accountability<br>North Carolina Implementation
        </p>
    </div>
    ...
    with col2:
        ...
        if st.button("Access VERA-NC", use_container_width=True):
    ...
    <div style="text-align: center; margin-top: 60px; color: #999; font-size: 0.85rem;">
        <p>VERA-NC analyzes ACCESS for ELLs domain data and EOG/EOC results across 115 North Carolina LEAs.</p>
        <p>~163,000-178,000 English Learners | 23-pt White-Black CCR Reading gap | 35.2% EL progress rate</p>
